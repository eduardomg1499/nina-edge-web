    ...
    <div className="space-y-6">
      <header className="mb-8 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400 mt-2">Control en tiempo real del telescopio NINA Edge</p>
        </div>
        
        <div className="flex items-center gap-4">
          {!hasActiveReservation && (
            <span className="text-amber-500 text-sm font-medium bg-amber-500/10 px-3 py-1.5 rounded-lg border border-amber-500/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-gray-950 border border-gray-800 rounded-2xl h-[600px] flex flex-col overflow-hidden relative">
            {/* Overlay Status */}
            <div className="absolute top-4 left-4 z-10 flex gap-2">
              <div className="bg-black/60 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-lg flex items-center gap-2">
                ...
                <span className="text-sm font-mono text-white">{status}</span>
              </div>
            </div>
            ...
            {currentImage ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-gray-600">
                ...
                <p>Esperando imagen de telemetria...</p>
                <p className="text-sm mt-2 font-mono">Selecciona un objeto para iniciar</p>
              </div>
            )}
            
            {/* Telemetry Bar */}
            <div className="bg-gray-900 border-t border-gray-800 p-4 flex justify-between items-center text-xs font-mono text-gray-400">
              <div className="flex gap-6">
                ...
                <span className={telemetry.tracking ? "text-emerald-400" : "text-amber-400"}>
                  TRACKING: {telemetry.tracking ? 'ON' : 'OFF'}
                </span>
              </div>
              <div className="flex gap-6">
